...
class GuestTable extends Component{
  ...
  showInforModal = () => {
    this.setState({ inforShow: true });
  };

  hideInforModal = () => {
    this.setState({ inforShow: false });
  };
        ...
        <table className="text-center">
          <thead className="py-2 text-xl">
            <tr>
              ...
              <td className="px-2">Passanger Number</td>
          ...
          <tbody>
            {this.props.reservation.filter(this.searchRfp).map((flight)=>(
              <tr className="text-lg"  key={flight._id} >
                ...
                <td>{this.state.reservationNumber}</td>
                ...
                <td className="flex items-center">
                  <Modal show={this.state.inforShow} handleClose={this.hideInforModal}>
                    <Detail information={flight}/>
                  </Modal>
                  <input type="button" value="Reservation" className="px-2 mx-2 py-2 bg-red-500 rounded-lg" onClick={this.handleReservation(flight.seatsNumber)} />
                  <input type="button" value="Detail" className="px-2 mx-2 py-2 bg-red-500 rounded-lg" onClick={this.showInforModal} />
                </td>
              </tr>
            ))}
          </tbody>
