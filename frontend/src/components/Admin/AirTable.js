...
class AirTable extends Component{
  ...
  handlePassengerNumber = (e) => {
    this.setState({searchPassangerNumber : e.target.value});
  }
        ...
        <table className="text-center">
          <thead className="py-2 text-xl">
            <tr>
              ...
              <td className="px-2"><input type="text" className="w-28 text-sm px-2 py-1" placeholder="Seats Numer" value={this.state.searchPassangerNumber}  onChange={this.handlePassengerNumber}/></td>
            ...
            <tr>
              ...
              <td className="px-2">Passenger Number</td>
